...
Based on how I cleaned the cat breeds, I found that there were <ins>25</ins> different cat breeds; however, several of the cats' breeds were unknown. I used a combination of text facets, text filters, clustering, and manually editing to clean this column and arrive at 25. I also learned to differentiate between the terminology for cat fur color/markings and cat breeds. If only the cat's fur color/marking was mentioned, I did not consider these in the breed column. I consulted the Cat Fancier's Association for information on breeds.[^4]
